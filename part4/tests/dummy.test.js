...
describe('Most popular', () => {
    ...
    //ask heikki about 4.5
    test('Most popular title', () => {
...
describe('Most popular', () => {
    ...
    test('Most popular author', () => {
        ...
        expect(result).toBe(finalCounter)
    })
})
describe('Most likes', () => {
    const blogs = [
